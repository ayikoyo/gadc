          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="admin-sub.php#tab_2"><i class="glyphicon glyphicon-list"></i>View classes</a></li>
            </ul>
            </li>
            <li class="treeview">
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-pills" id="customtabs">
              <li class="active"><a href="#tab_1" data-toggle="tab"><i class="glyphicon glyphicon-pencil"></i>New subject</a></li>
              <!-- <li><a href="#tab_2" data-toggle="tab">Tab 2</a></li>
              <li><a href="#tab_3" data-toggle="tab">Tab 3</a></li> -->
              <li class=""><a data-toggle="tab" href="#tab_2"><i class="glyphicon glyphicon-list"></i>
                  View subjects  <!-- <span class="caret"></span> -->
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-header with-border">
                    <h3 class="box-title">New subject registration</h3>
                  </div>
                  <div class="box-body">
                    <div class="input-group">
...
<!-- AdminLTE App -->
<script src="..plugins/jQueryUI/custom.js" type="text/javascript"></script>
