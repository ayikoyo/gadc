        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-pills">
              <li class="active"><a href="#tab_1" data-toggle="tab"><i class="glyphicon glyphicon-list"></i>Test report</a></li>
              <!-- <li><a href="#tab_2" data-toggle="tab">Tab 2</a></li>
              <li><a href="#tab_3" data-toggle="tab">Tab 3</a></li> -->
              <li >
                <a data-toggle="tab" href="#tab_2"><i class="glyphicon glyphicon-list"></i>
                  Examination report  <!-- <span class="caret"></span> -->
              ...
              <div class="row">
                ...
                <div class="col-md-2 col-sm-2">
                  <div class="input-group">
                    ...
                    <select class="form-control select2"><option>Select</option></select>
                  </div>
                </div>
                <div class="col-md-2 col-sm-2">
                  <div class="input-group">
