      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="st.php#tab_1"><i class="glyphicon glyphicon-pencil"></i> New student</a></li>
            <li><a href="st.php#tab_2"><i class="glyphicon glyphicon-list"></i> View students</a></li>
          </ul>
        </li>
        <li class="treeview">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                    ...
                    <div class="input-group">
                      ...
                      <input type="date" class="form-control" name="parent" placeholder="Enter full name of parent">
                    </div>
                    <br>
                    <div class="input-group">
                      <span class="input-group-addon">Telephone number</span>
                      <input type="date" class="form-control" name="phone" placeholder="Enter phone number">
                    </div>
                    <br>
                    <div class="input-group">
