...
<?php
  ...
  GLOBAL $sql;
  /*============creating object for the connection class===========*/
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="student.php#tab_1"><i class="glyphicon glyphicon-pencil"></i> New student</a></li>
            <li><a href="student.php#tab_2"><i class="glyphicon glyphicon-list"></i> View students</a></li>
          </ul>
        </li>
        <li class="treeview">
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-pills">
              <li class="active"><a href="#tab_1" data-toggle="tab"><i class="glyphicon glyphicon-user"></i>New teacher</a></li>
              <!-- <li><a href="#tab_2" data-toggle="tab">Tab 2</a></li>
              <li><a href="#tab_3" data-toggle="tab">Tab 3</a></li> -->
              <li >
                <a data-toggle="tab" href="#tab_2"><i class="glyphicon glyphicon-list"></i>
                  View staff list  <!-- <span class="caret"></span> -->
              ...
              <div class="tab-pane active" id="tab_1">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon">Usertype</span>
          ...
          <div class="box">
            ...
            <form id="form" action="">
              <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                  <div class="input-group">
                    <button class="btn btn-default btn-warning" type="submit" name="search" id="btn-search">Search</button>
                  </div>
                </div>
            </div>
            </form>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><form action="" method="post">
                    <button class="btn btn-md btn-primary glyphicon glyphicon-pencil">Edit</button>
                    <button class="btn btn-md btn-warning glyphicon glyphicon-warning-sign">Suspend</button>
                    <button class="btn btn-md btn-danger glyphicon glyphicon-remove">Delete</button>
                  </form></td>
                </tr>
                <tr>
                  <td>Trident</td>
...
<!-- Ajax -->
<script src="../bower_components/ajax/jquery-3.3.1.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script type="text/javascript">
  $(document).ready(function(){
    $(#btn-search).click(function(){
      ...
      var class = $(#class).val();
      if( name == '' || clas==''){
        alert("Name or class is missing");
      }else{
        alert("Page loading done");
      }
