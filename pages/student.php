...
<?php
  ...
  if(isset($_POST['submit'])){
    $student->newStudent($conn,$_POST['fname'],$_POST['lname'],$_POST['gender'],$_POST['dob'],$_POST['stream'],$_POST['parent'],$_POST['phone']);
  }
  if(isset($_POST['search'])){
    ...
    if(!empty($name)){
      ...
      $data = (explode(' ',$name,2)); //split the names given into two different names
      // for($i= 0;$i<sizeof($data);$i++){
      //   echo $data[$i];
      // }
      $fname = $data[0];
      $lname = $data[1];
      $sql = $student-> selectOneStudent($conn,$fname,$lname);

    }else{ // retrieve student details by class, term and year
...
<head>
  ...
  <title>SMS | Administration simplified</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="st.php">
            <i class="glyphicon glyphicon-user"></i> <span>Student portal</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#tab_1"><i class="glyphicon glyphicon-pencil"></i> New student</a></li>
            <li><a href="#tab_2"><i class="glyphicon glyphicon-list"></i> View students</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="tst-admin.php">
            <i class="glyphicon glyphicon-list-alt"></i> <span>Examinations</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="tst-admin.php#tab_1"><i class="glyphicon glyphicon-list"></i> Tests report</a></li>
            <li><a href="tst-admin.php#tab_2"><i class="glyphicon glyphicon-list"></i> Termly reports</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="stf.php">
          ...
          <ul class="treeview-menu">
            <li><a href="stf.php#tab_1"><i class="glyphicon glyphicon-pencil"></i>New teacher</a></li>
            <li><a href="stf.php#tab_2"><i class="fa fa-users"></i> View teachers</a></li>
          </ul>
        </li>
        <!-- <li>
          <a href="../widgets.html">
        ...
        <li class="treeview">
          <a href="#">
            <i class="glyphicon glyphicon-wrench"></i> <span>Admin controls</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              <a href="admin-sub.php"><i class="glyphicon glyphicon-file"></i>Subjects
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="admin-sub.php#tab_1"><i class="glyphicon glyphicon-pencil"></i>New subject</a></li>
                <li><a href="admin-sub.php#tab_2"><i class="glyphicon glyphicon-list"></i>View subjects</a></li>
                <!-- <li><a href="#"><i class="glyphicon glyphicon-remove"></i>Delete subject</a></li> -->
                <!-- <li class="treeview">
                  <a href="#"><i class="fa fa-list-alt"></i> Level Two
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a> -->
            ...
            <li class="treeview">
              <a href="admin-str.php"><i class="fa fa-users"></i>Class
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="admin-str.php#tab_1"><i class="glyphicon glyphicon-pencil"></i>New class</a></li>
                <li><a href="admin-str.php#tab_2"><i class="glyphicon glyphicon-list"></i>View classes</a></li>
                <!-- <li><a href="#"><i class="glyphicon glyphicon-remove"></i>Delete class</a></li> -->
            </ul>
            </li>
            <li class="treeview">
              <a href="admin-usr.php"><i class="glyphicon glyphicon-user"></i>Users
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="admin-usr.php#tab_1"><i class="glyphicon glyphicon-pencil"></i>New user</a></li>
                <li><a href="admin-usr.php#tab_2"><i class="fa fa-users"></i>View users</a></li>
            </ul>
            </li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- START CUSTOM TABS -->
      <!-- <h2 class="page-header">Student portal</h2> -->

      <div class="row">
        <div class="col-md-12">
          <!-- Custom Tabs -->
          <div class="nav-tabs-custom">
            <ul class="nav nav-pills" id="customtabs">
              <li class="active"><a href="#tab_1" data-toggle="tab"><i class="glyphicon glyphicon-user"></i>New student</a></li>
              <!-- <li><a href="#tab_2" data-toggle="tab">Tab 2</a></li>
              <li><a href="#tab_3" data-toggle="tab">Tab 3</a></li> -->
              <li class=""><a data-toggle="tab" href="#tab_2"><i class="glyphicon glyphicon-list"></i>
                ...
                <!-- <ul class="dropdown-menu"> -->
                  <!-- <li role="presentation"> P.1 </li>
                  <li role="presentation">P.2</li>
                  <li role="presentation">P.3</li>
                  <li role="presentation">P.4</li>
                  <li role="presentation">P.5</li> -->
                  <!-- <select>
                    <option>P.1</option>
                  </select>
                </ul> -->
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                <div class="box box-primary">
                  <form id="studentform">
                  <div class="box-header with-border">
                    <h3 class="box-title">Registration page</h3>
                  </div>
                  <div class="box-body">
                    <div class="input-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="lname" id="lname" placeholder="Enter other name">
                    </div>
                    <br>
                    <div class="input-group">
                    ...
                    <br>
                    <div class="input-group">
                      <span class="input-group-addon">Name of parent</span>
                      <input type="text" class="form-control" name="parent" id="parent" placeholder="Enter full name of parent">
                    </div>
                    <br>
                    <div class="input-group">
                      <span class="input-group-addon">Telephone number</span>
                      <input type="date" class="form-control" name="phone" id="phone" placeholder="Enter phone number">
                    </div>
                    <br>
                    <div class="input-group">
                      <input type="button" class="btn btn-block btn-primary" name="submit" id="sub_student" value="Submit">
                    </div>
                    <!-- /input-group -->
                  </div>
                  <!-- /.box-body -->
          ...
          <div class="box">
            ...
            <form action="" method="post">
              <div class="row">
                ...
                <div class="col-md-2 col-sm-2">
                  <div class="input-group">
                    <span class="input-group-addon">Class</span>
                    <select class="form-control select2" name="stream"><option>Select</option></select>
                  </div>
                </div>
                <div class="col-md-2 col-sm-2">
                  <div class="input-group">
                    <span class="input-group-addon">Year</span>
                    <select class="form-control select2" name="year"><option>Select</option></select>
                  </div>
                </div>
                <div class="col-md-2 col-sm-2">
                  <div class="input-group">
                    <span class="input-group-addon">Term</span>
                    <select class="form-control select2" name="term"><option>Select</option></select>
                  </div>
                </div>
                <div class="col-md-2 col-sm-2">
                  <div class="input-group">
                    <button class="btn btn-default btn-warning" type="submit" name="search">Search</button>
                  </div>
                </div>
            </div>
            </form>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                <thead>
                <tr>
                  <th><i class="glyphicon glyphicon-pencil"></i>Name</th>
                  <th><i class="fa fa-male"></i><i class="fa fa-female"></i>Sex</th>
                  <th><i class="fa fa-moon-o"></i>Age</th>
                  <th><i class="glyphicon glyphicon-user"></i>Name of parent</th>
                  <th><i class="glyphicon glyphicon-earphone"></i>Telephone</th>
                ...
                <tbody>
                  ...
                  while($row=mysqli_fetch_array($sql))
                      ...
                      echo '<td><form action="" method="post"><button class="btn btn-sm btn-primary glyphicon glyphicon-pencil">Edit</button><button class="btn btn-sm btn-danger glyphicon glyphicon-remove">Delete</button>
                        </form></td>';
                      echo '</tr>';
                ?>
...
<!-- <script type="text/javascript">
  $(#customtabs).tabify({'disabled':'true'});
</script> -->
</body>
</html>
